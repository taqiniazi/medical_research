...
# -*- coding:utf-8 -*-
"""
CT Metal Artifact Training Data Generator
...
class CTMetalArtifactGenerator:
    """Generator for CT metal artifact training data"""
    ...
    def __init__(self, output_dir="./data", image_size=256, num_train=100, num_test=20):
        ...
        print(f"CT Metal Artifact Data Generator")
    ...
    def generate_synthetic_ct_image(self, size):
        ...
        for i in range(5):
            ...
            # Create line
            line_mask = np.zeros(size, dtype=np.uint8)
            cv2.line(line_mask, 
                    (center_x, center_y),
                    (center_x + int(length * np.cos(angle)), 
                     center_y + int(length * np.sin(angle))),
                    255, thickness)
...
def main():
    ...
    print("CT Metal Artifact Training Data Generator")
    ...
    # Create generator
    generator = CTMetalArtifactGenerator(
